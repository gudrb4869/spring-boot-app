...
@AnalyzeClasses(packagesOf = SpringBootAppApplication.class)
public class PackageDependencyTests {
    ...
    public static final String MODULES = "io.hyungkyu.app.modules..";
    public static final JavaClasses CLASS = new ClassFileImporter().importPackagesOf(SpringBootAppApplication.class);
    ...
    @ArchTest
    ArchRule cycleRule = slices().matching("io.hyungkyu.app.modules.(*)..")
            .should()
            .beFreeOfCycles();
