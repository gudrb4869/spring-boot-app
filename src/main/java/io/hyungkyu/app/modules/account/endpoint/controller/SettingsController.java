...
import io.hyungkyu.app.modules.account.endpoint.controller.form.*;
import io.hyungkyu.app.modules.account.endpoint.controller.validator.NicknameFormValidator;
import io.hyungkyu.app.modules.account.endpoint.controller.validator.PasswordFormValidator;
...
public class SettingsController {
    ...
    private final ObjectMapper objectMapper; // 스프링이 자동으로 빈으로 등록해주는 ObjectMapper를 주입받음.
    ...
    public String updateTags(@CurrentUser Account account, Model model) {
        ...
        try {
            whitelist = objectMapper.writeValueAsString(allTags); // List를 JSON 형태로 변환함.
