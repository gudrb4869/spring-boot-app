package io.hyungkyu.app.modules.account.domain.entity;
...
public class Account extends AuditingEntity {
    ...
    public void updateProfile(io.hyungkyu.app.modules.account.endpoint.controller.form.Profile profile) {
